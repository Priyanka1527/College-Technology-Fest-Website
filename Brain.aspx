<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Brain.aspx.cs" Inherits="Brain" %>
...
<div id="eventcontent">
<div id="accordion-1">
            <dl><dt>Brain Teaser</dt>
                <dd><img src="posters/brain-teaser.jpg" width="300px" height="250px" /></dd>
                <dt>About The Event</dt>
                <dd><h2>Brain Teaser</h2><p>Tired of using the brain throughout the year? Time to tease it then ! Brainteaser event brings to you the oppurtunity to Baffle your brain by cracking some tough puzzles in quick time. <br /><br/>Prize money would be declared on spot. Excitement galore.</p></dd>
                <dt>Timing Of The Event</dt>
                <dd><h2>TIMING</h2><p>This event will be conducted in different time slots:<br/>
1stSlot : 10:30am to 11:30pm<br/>
2ndSlot : 11:45pm to 12:45pm<br/>
3rdSlot : 1:00pm to 2:00pm<br/>
4thSlot : 2:30pm to 3:30pm<br/>
5thSlot : 3:45pm to 4:45pm <br/>
</p></dd>
<dt>Registration</dt>
                <dd><h2>REGISTRATION:

</h2><br/><br/><p>i)	  Participants shouldenroll their names before every exam slots.<br/>
ii)  Registration fee is  Rs. 10 for each participants for each exam slots.<br/>

<br /></p></dd>

                <dt>Rules & Regulations</dt>
                <dd><h2>RULES & REGULATIONS:</h2><p>The four departments would be forming separate stalls. 
The stage is set to show your intellect. Bring it on! #srey2k14<br/>
i) There will be no negative marking except in case of a tie.<br/>
ii) Winners and Runners will be declared according to the process of giving  maximum right answers within minimum time.<br/>
iii) Results will be declared within 30 minutes after the completion of respective exam slots.<br/>
...
<br /><br />
Reetam Taj: 8697441771<br />
Nilanjan Mukherjee: 9038701110
 <br /><br />
