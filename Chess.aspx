<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chess.aspx.cs" Inherits="Chess" %>
...
<div id="accordion-1">
            <dl><dt>CHECKMATE</dt>
                <dd><img src="posters/chess.jpg" width="550px" height="250px"  alt=""/></dd>
                <dt>About The Event</dt>
                <dd><h2>CHECKMATE</h2><p>A Chess game is a dialogue, a conversation between a player and his opponent. Each move by the opponent may contain threats or be a
blunder, but a player cannot defend against threats or take
advantage of blunders if he does not first ask himself:
What is my opponent planning after each move?<br />So, are you ready to read the mind of your oponent??<br />
PRIZE MONEY:<br />
1st Prize:3000INR<br />
2nd Prize:1500INR<br />
3rd Prize:1000INR</p></dd>
                <dt>Registration</dt>
                <dd><h2>REGISTRATION:
...
iii)	Registration fee: 50 INR per head <br />
iv)	Registration is confirmed only when the registration fee is paid at the venue .<br />
v)	Online Registered candidates will be provided pre-generated Ids.

<br /></p></dd>
                 
                <dt>Rules & Regulations</dt>
                <dd><h2>RULES & REGULATIONS:</h2><p>i)	Each player must make all his moves within the <a span style="color:red">12minutes</a> time, alloted for the game. <br />
<br />
ii)	Winner of the lower levels are allowed to participate in the nexe levels.<br />
For more details <span style="color:red"><a href="blitz.pdf">CLICK HERE</a></span><br /> </p></dd>              
            </dl>
        </div>
</div>
<div id="eventbody">
...
Saptaparni Neogi<br />
Priyanka Saha <br />
Phone No.-+919475864872<br />
Email: checkmate2k14@gmail.com<br />
<br /><br />
