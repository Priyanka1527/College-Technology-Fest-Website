<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reach.aspx.cs" Inherits="Reach" %>
...
<div id="eventcontent">
<div id="accordion-1">
            <dl><dt>Chalice of Fortune</dt>
                <dd><img src="posters/reach.jpg" width="550px" height="250px" /></dd>
                <dt>About The Event</dt>
                <dd><h2>Chalice of Fortune</h2><p>Searching for a hidden treasure has been a fundamental part of human nature since mankind’s inception. And what greater treasure than the biggest treasure of them all?For centuries civilizations have risen and fallen in search for the sacred chalice of fortune, the one greatest treasure even known to mankind.  <br />
And now it’s your turn. Get into your running boots, brush up the hidden adventure inside you and get ready to wrack your grey cells together, because the sacred chalice of fortune awaits with a bountiful prize for the deserving seeker.<br /></p></dd>
                <dt>PRIZE MONEY</dt>
                <dd><h2>PRIZE MONEY</h2><br/><br/><p>Winning Prize Money: 3500 INR</p></dd><dt>Registration</dt>
                <dd><h2>REGISTRATION:

</h2><p>i)	Online and on-spot registration between 8:30AM to 10:00AM. <br />
ii)	No new registrations will be entertained after the stipulated time <br />
iii)	Registration fee: 250 INR per team ( minimum 3 members ,maximum 4 members) <br />
iv)	Registration is confirmed only when the registration fee is paid at the venue .<br />
v)	No common member can be present in multiple teams.<br />
vi)	Online Registered candidates will be provided pre-generated Ids.

<br /></p></dd>
                <dt>Rules & Regulations</dt>
                <dd><h2>RULES & REGULATIONS:</h2><p>i)	Usage of cellphone or any electronic gadgets is strictly prohibited during the event.<br />
ii)	No misbehavior will be tolerated and teams found guilty shall be disqualified immediately without any refund.<br />
iii)	The decision of the organizing committee shall be final.<br />
iv)	Stage specific rules shall be provided on the spot by the organizers and full cooperation in expected.<br />
v)	In any case the registration fee is non-refundable.
</p></dd>      
...
<br /><br />
Angad Jain: 7278204813 / 9088765716<br />
Ankit Dutta Gupta: 8017249983 / 8961220807<br />
Jarvis J Altrin: 9874813505<br />
Sakait Bajpai: 8961117475
<br /><br />
